...
/*
 * NOTICE:
 * The following source file includes a modified copy of 
 * the PeekingIterator class in Apache Commons Collections 4.4.
 */
...
class PeekingIterator<E> implements Iterator<E> {
     ...
     */
    static <E> PeekingIterator<E> peekingIterator(final Iterator<? extends E> iterator) {
